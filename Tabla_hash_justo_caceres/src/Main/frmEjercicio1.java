...
public class frmEjercicio1 extends javax.swing.JDialog {
    ...
    private void btnMostrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMostrarActionPerformed
        ...
        while(matcher.find()){
            ...
            if (token1 != null) {
                kk++;
                System.out.println("Hash -> "+hash(kk)+" | Palabras reservadas: " + token1);
            ...
            if (token2 != null) {
                kk++;
                System.out.println("Hash -> "+hash(kk)+" | Identificadores: " + token2);
            }
            
            String token3 = matcher.group(3);
            if (token3 != null) {
                kk++;
                System.out.println("Hash -> "+hash(kk)+" | Operadores relacionales: " + token3);
            }
            
            String token4 = matcher.group(4);
            if (token4 != null) {
                kk++;
                System.out.println("Hash -> "+hash(kk)+" | Operadores de aritméticos: " + token4);
            }
            
            String token5 = matcher.group(5);
            if (token5 != null) {
                kk++;
                System.out.println("Hash -> "+hash(kk)+" | Operadores de asignación: " + token5);
            }
            
            String token6 = matcher.group(6);
            if (token6 != null) {
                kk++;
                System.out.println("Hash -> "+hash(kk)+" | Números: " + token6);
            }
            
            String token7 = matcher.group(7);
            if (token7 != null) {
                kk++;
                System.out.println("Hash -> "+hash(kk)+" | Operadores de incremento/decremento: " + token7);
            }
            
            String token8 = matcher.group(8);
            if (token8 != null) {
                kk++;
                System.out.println("Hash -> "+hash(kk)+" | Parentesis: " + token8);
            }
            
            String token9 = matcher.group(9);
            if (token9 != null) {
                kk++;
                System.out.println("Hash -> "+hash(kk)+" | Llaves: " + token9);
            }
            
            String token10 = matcher.group(10);
            if (token10 != null) {
                kk++;
                System.out.println("Hash -> "+hash(kk)+" | Corchetes: " + token10);
            }
            
            String token11 = matcher.group(11);
            if (token11 != null) {
                kk++;
                System.out.println("Hash -> "+hash(kk)+" | Punto y coma: " + token11);
            }
            
            String token12 = matcher.group(12);
            if (token12 != null) {
                kk++;
                System.out.println("Hash -> "+hash(kk)+" | Punto: " + token12);
            }
        }
